...
local FilterTableNames = {
	...
	["Other"] = AL["Other"],
	["Relic"] = BabbleInventory["Relic"],
	["ItemSlot"] = AL["Itemslot"],
	["Stats"] = AL["Stats"],
}

local FilterSort = {"Armor", "Other", "ItemSlot", "WeaponsMeele", "WeaponsMeeleTwoHand", "WeaponsRanged", "Relic", "Stats"}
local FilterTable = {
	["Armor"] = {
		"#a1#",				-- Cloth
		"#a2#",				-- Leather
