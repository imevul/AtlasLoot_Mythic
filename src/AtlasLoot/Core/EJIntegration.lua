...
function AtlasLoot:EncounterJournal_Initialize()
    ...
    if AtlasLoot.ItemFrame then
        AtlasLoot.ItemFrame.EncounterJournal = self:EncounterJournal_CreateButton("AtlasLootItemsFrame_EncounterJournal",
            AtlasLoot.ItemFrame)
    ...
    if AtlasLoot.CompareFrame then
        AtlasLoot.CompareFrame.EncounterJournal = self:EncounterJournal_CreateButton(
        "AtlasLootCompareFrame_EncounterJournal", AtlasLoot.CompareFrame)
