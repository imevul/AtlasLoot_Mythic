	...
	["Instances"] = {
		...
		["BlackrockDepths"] = {
			["Bosses"] = {
				...
				{ "BlackrockDepthsGeneralAngerforge", 13 },
				{ "BlackrockDepthsGolemLordArgelmach", 14 },
				{ "BlackrockDepthsGrimGuzzler", 15 },
				{ "BlackrockDepthsAmbassadorFlamelash", 16 },
				{ "BlackrockDepthsSummonersTomb", 17 },
				{ "BlackrockDepthsMagmus", 18 },
				{ "BlackrockDepthsEmperorDagranThaurissan", 19 },
				{ "BlackrockDepthsPanzorTheInvincible", 20 },
				{ "BlackrockDepthsTrash", 21 },
			},
...
--		},
		...
		["BlackrockSpireLower"] = {
			["Bosses"] = {
				...
				{ "LowerBlackrockSpireMotherSmolderweb", 4 },
				{ "LowerBlackrockSpireUrokDoomhowl", 5 },
				{ "LowerBlackrockSpireQuartermasterZigris", 6 },
				{ "LowerBlackrockSpireHalycon", 7 },
				{ "LowerBlackrockSpireGizrulTheSlavener", 8 },
				{ "LowerBlackrockSpireOverlordWyrmthalak", 9 },
				{ "LowerBlackrockSpireBurningFelguard", 10 },
				{ "LowerBlackrockSpireSpirestoneButcher", 11 },
				{ "LowerBlackrockSpireBannokGrimaxe", 12 },
				{ "LowerBlackrockSpireCrystalFang", 13 },
				{ "LowerBlackrockSpireSpirestoneBattleLord", 14 },
				{ "LowerBlackrockSpireSpirestoneLordMagus", 15 },
				{ "LowerBlackrockSpireGhokBashguud", 16 },
				{ "LowerBlackrockSpireTrash", 17 },
			},
		...
		["BlackrockSpireUpper"] = {
			["Bosses"] = {
				...
				{ "UpperBlackrockSpireGeneralDrakkisath", 7 },
				{ "UpperBlackrockSpireJedRunewatcher", 8 },
				{ "UpperBlackrockSpireTrash", 9 },
			},
		...
		["Scholomance"] = {
			["Bosses"] = {
				...
				{ "ScholomanceLorekeeperPolkelt", 8 },
				{ "ScholomanceDoctorTheolenKrastinov", 9 },
				{ "ScholomanceInstructorMalicia", 10 },
				{ "ScholomanceLadyIlluciaBarov", 11 },
				{ "ScholomanceLordAlexeiBarov", 12 },
				{ "ScholomanceTheRavenian", 13 },
				{ "ScholomanceDarkmasterGandling", 14 },
				{ "ScholomanceTrash", 15 },
			},
