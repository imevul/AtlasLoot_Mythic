...
AtlasLoot_LootTableRegister = {
    ["Instances"] = {
        ...
        ["StratholmeCrusader"] = {
            ["Bosses"] = {
				{ "LiveStratholmeSkul",                  1 },
                { "LiveStratholmeFrasSiabi",             2 },
                { "LiveStratholmePostmasterMalown",     3 },
                { "LiveStratholmeHearthsingerForresten", 4 },
				{ "LiveStratholmeTheUnforgiven",         5 },
                { "LiveStratholmeTimmyTheCruel",         6 },
                { "LiveStratholmeMalorTheZealous",       7 },
                { "LiveStratholmeCrimsonHammersmith",    8 },
                { "LiveStratholmeCannonMasterWilley",    9 },
                { "LiveStratholmeArchivistGalford",      10 },
                { "LiveStratholmeBalnazzar",             11 },
                { "LiveStratholmeSothosJarien",          12 },
                { "StratholmeTrash",                     13 },
            },
        ...
        ["StratholmeGauntlet"] = {
            ["Bosses"] = {
				...
				{ "UndeadStratholmeStonespine",           2 },
                { "UndeadStratholmeBaronessAnastari",     3 },
				{ "UndeadStratholmeBlackGuardSwordsmith", 4 },
                { "UndeadStratholmeNerubenkan",           5 },
                { "UndeadStratholmeMalekiThePallid",      6 },
                { "UndeadStratholmeRamsteinTheGorger",    7 },
                { "UndeadStratholmeBaronRivendare",       8 },
                { "StratholmeTrash",                      9 },
            },
