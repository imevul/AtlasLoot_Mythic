...
AtlasLoot_LootTableRegister = {
	["Instances"] = {
		...
		["BlackTemple"] = {
			...
			["BlackTempleBasement"] = {
				{ "BlackTempleTeronGorefiend", 4 },
				{ "BlackTempleGurtoggBloodboil", 5 },
				{ "BlackTempleReliquaryOfSouls", 6 },
			},
			["BlackTempleTop"] = {
				{ "BlackTempleMotherShahraz", 7 },
				{ "BlackTempleTheIllidariCouncil", 8 },
				{ "BlackTempleIllidanStormrage", 9 },
				{ "BlackTempleTrash", 10 },
				{ "BlackTemplePatterns", 11 },
			},
		...
		["KarazhanEaI"] = {
			...
			["KarazhanEnd"] = {
				{ "KarazhanTheCurator", 7 },
				{ "KarazhanTerestianIllhoof", 8 },
				{ "KarazhanShadeOfAran", 9 },
				{ "KarazhanNetherspite", 10 },
				{ "KarazhanChess", 11 },
				{ "KarazhanPrinceMalchezaar", 12 },
				{ "KarazhanTrash", 13 },
			},
