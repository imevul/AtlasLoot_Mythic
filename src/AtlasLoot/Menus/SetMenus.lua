    ...
    ["Normal"] = {
        {
            ...
            { 6,  "ZGSets",      "achievement_boss_hakkar",               "=ds=" .. BabbleZone["Zul'Gurub"] .. " " .. AL["Set"],           "=q5=" .. AL["Classic WoW"] },
...
AtlasLoot_Data["T1T2T3SET"] = {
    ["Normal"] = {
        {            
			{ 1, "T3DeathKnight", "spell_deathknight_classicon", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5=" .. AL["Tier 3+ Set"] },
            { 3, "T1T2Druid", "ability_druid_maul", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 4, "T3Druid", "ability_druid_maul", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5=" .. AL["Tier 3+ Set"] },
			{ 6, "T1T2Hunter", "inv_weapon_bow_07", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 7, "T3Hunter", "inv_weapon_bow_07", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "=q5=" .. AL["Tier 3+ Set"] },
            { 9, "T1T2Mage", "inv_staff_13", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["MAGE"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 10, "T3Mage", "inv_staff_13", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["MAGE"], "=q5=" .. AL["Tier 3+ Set"] },
            { 12, "T1T2Paladin", "ability_thunderbolt", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 13, "T3Paladin", "ability_thunderbolt", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5=" .. AL["Tier 3+ Set"] },
            { 16, "T1T2Priest", "inv_staff_30", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 17, "T3Priest", "inv_staff_30", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5=" .. AL["Tier 3+ Set"] },
            { 19, "T1T2Rogue", "inv_throwingknife_04", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 20, "T3Rogue", "inv_throwingknife_04", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "=q5=" .. AL["Tier 3+ Set"] },
            { 22, "T1T2Shaman", "spell_nature_bloodlust", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 23, "T3Shaman", "spell_nature_bloodlust", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5=" .. AL["Tier 3+ Set"] },
            { 25, "T1T2Warlock", "spell_nature_drowsy", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 26, "T3Warlock", "spell_nature_drowsy", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "=q5=" .. AL["Tier 3+ Set"] },
            { 28, "T1T2Warrior", "inv_sword_27", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5=" .. AL["Tier 1/2 Set"] },
            { 29, "T3Warrior", "inv_sword_27", "=ds=" .. LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5=" .. AL["Tier 3+ Set"] },
        },
    },
    info = {
