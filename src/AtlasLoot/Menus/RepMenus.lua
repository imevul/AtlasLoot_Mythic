    ...
    ["Normal"] = {
        {
            ...
            { 4,  "AllianceVanguard",        "spell_misc_hellifrepvphonorholdfavor",         "=ds=" .. BabbleFaction["Alliance Vanguard"],       "=q5=" .. BabbleFaction["Alliance"] },
            ...
            { 9,  "TheSonsofHodir",          "Spell_Holy_DivinePurpose",                     "=ds=" .. BabbleFaction["The Sons of Hodir"],       "=q5=" .. BabbleZone["The Storm Peaks"] },
            { 10, "ArgentTournamentFaction", "inv_misc_tabardpvp_01",                        "=ds=" .. BabbleFaction["The Silver Covenant"],     "=q5=" .. BabbleZone["Icecrown"] .. " / " .. BabbleZone["Dalaran"] },
            { 17, "REPMENU_BURNINGCRUSADE",  "INV_Misc_Ribbon_01",                           "=ds=" .. AL["Burning Crusade"],                    "" },
            { 19, "HordeExpedition",         "spell_misc_hellifrepvpthrallmarfavor",         "=ds=" .. BabbleFaction["Horde Expedition"],        "=q5=" .. BabbleFaction["Horde"] },
            { 20, "TheKaluak",               "achievement_reputation_tuskarr",               "=ds=" .. BabbleFaction["The Kalu'ak"],             "" },
            ...
            { 24, "TheAshenVerdict",         "INV_Jewelry_Ring_85",                          "=ds=" .. BabbleFaction["The Ashen Verdict"],       "=q5=" .. BabbleZone["Icecrown"] },
            { 25, "ArgentTournamentFaction", "inv_misc_tabardpvp_02",                        "=ds=" .. BabbleFaction["The Sunreavers"],          "=q5=" .. BabbleZone["Icecrown"] .. " / " .. BabbleZone["Dalaran"] },
        },
    },
    info = {
        name = AL["Factions"],
    ...
    ["Normal"] = {
        {
            ...
            { 26, "Orgrimmar",          "inv_misc_tournaments_symbol_orc",      "=ds=" .. BabbleFaction["Orgrimmar"],           "=q5=" .. BabbleFaction["Horde"] },
            { 27, "SilvermoonCity",     "inv_misc_tournaments_symbol_bloodelf", "=ds=" .. BabbleFaction["Silvermoon City"],     "=q5=" .. BabbleFaction["Horde"] },
            { 28, "ThunderBluff",       "inv_misc_tournaments_symbol_tauren",   "=ds=" .. BabbleFaction["Thunder Bluff"],       "=q5=" .. BabbleFaction["Horde"] },
            { 29, "Undercity",          "inv_misc_tournaments_symbol_scourge",  "=ds=" .. BabbleFaction["Undercity"],           "=q5=" .. BabbleFaction["Horde"] },
        },
    },
    info = {
