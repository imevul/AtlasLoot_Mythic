...
if AL then
    ...
    AL["Are you sure you want to delete Sort list |cff1eff00%s|r?"] =
    "Möchten Sie die Sortierliste |cff1eff00%s|r wirklich löschen?";
    ...
    -- AL["Slot"] = true;
    AL["AtlasLoot has detected some corrupted items on your Wishlist. You can now run an automatic check to fix it. Please be aware that this could take a few moments."] =
    "AtlasLoot hat einige beschädigte Einträge auf Ihrem Wunschzettel gefunden. Sie können jetzt eine automatische Überprüfung zur Behebung des Problems ausführen. Dies kann einige Zeit in Anspruch nehmen.";
    ...
    AL["For further help, see our website and forums: "] =
    "Bitte besuchen Sie für weitere Hilfe die Webseite und das Forum: ";
    ...
    "Sollte AtlasLootFu aktiviert sein, klicken Sie einfach den Minimap Button oder den Button in einem installierten Mod wie Titan oder FuBar. Andernfalls können Sie auch einfach '/al' im Chatfenster eingeben.";
    ...
    "Die Symbole unsicherer Gegenstände sind rot umrandet und gekennzeichnet, da sie seit dem letzten Patch oder Serverneustart nicht gesehen wurden. Rechtsklicken Sie den Gegenstand und bewegen dann die Maus wieder über selbigen oder nutzen Sie den 'Serverabfrage' Button am unteren Ende der Beute-Seite.";
    ...
    "Strg+Linksklick auf den Gegenstand. Teilweise wird die Anprobe durch die Atlas oder AtlasLoot Fenster verdeckt. Wenn also nichts passiert, bewegen Sie diese Fenster an einen anderen Platz.";
    ...
    "Shift+Linksklick auf den zu verlinkenden Gegenstand";
    ...
    "Alt+Linksklick auf einen Gegenstand fügt ihn zum Wunschzettel hinzu.";
    AL["Ctrl+Alt+Left Click any item to add it to the wishlist."] =
    "Strg+Alt+Linksklick auf einen Gegenstand fügt ihn zum Wunschzettel hinzu.";
    ...
    "Zum Entfernen eines Gegenstandes müssen Sie diesen einfach im Wunschzettel Alt+Linksklicken.";
    AL["While on the wishlist screen, just Ctrl+Alt+Left Click on an item to delete it."] =
    "Zum Entfernen eines Gegenstandes müssen Sie diesen einfach im Wunschzettel Strg+Alt+Linksklicken.";
    AL["How to open an item in LootDb:"] = "Einen Gegenstand in LootDb öffnen:";
    AL["Alt+Left Click any item to open it in LootDb."] = "Alt+Linksklick auf einen Gegenstand öffnet ihn in LootDb.";
    ...
    "Mit einem Linksklick auf einen Gegenstand auf dem Wunschzettel gelangen Sie zu dem Beuteverzeichnis aus dem der Gegenstand stammt. Des Weiteren wird jeder bereits auf dem Wunschzettel befindliche Gegenstand in den Verzeichnissen mit einem zuvor vergebenen Symbol vermerkt.";
    ...
    "Nutzen Sie den Zurücksetzen Button im Optionsmenü oder geben Sie '/al reset' im Chatfenster ein.";
    ...
    AL["Use the standard GameTooltip instead of the custom AtlasLoot tooltip"] =
    "Statt dem angepassten AtlasLoot-ToolTip den normalen Spiel-ToolTip verwenden";
    -- AL["%d / %d ( Bank: %d )"] = true;
    -- Unsafe Item
    AL["Item Unavailable"] = "Item nicht verfügbar";
    AL["|cff0070ddItemID: %d |r\nThis item is unsafe.  To view this item without the risk of disconnection, you need to have first seen it in the game world.\n\nYou can right-click to attempt to query the server.  You may be disconnected."] =
    ...
    AL["Are you sure you want to delete Wishlist |cff1eff00%s|r?"] =
    "Soll der Wunschzettel |cff1eff00%s|r wirklich gelöscht werden?";
    AL["default"] = "Standard";
    ...
    AL["Other"] = "Andere";
    -- AL["Itemslot"] = true;
    AL["Shift + Click on the Filter button opens the config page."] =
    "Shift + Klick auf den Filterbutton öffnet die Konfiguration.";
    ...
    AL["Shows unused QuickLooks as grey buttons in the AtlasLoot Panel"] =
    "Zeigt ungenutzte Lesezeichen in der AtlasLoot-Leiste ausgegraut an";
    -- Single options
    AL["unused"] = "ungenutzt";
    ...
    AL["This is a loot browser only.  To view maps as well, install either Atlas or Alphamap."] =
    "Atlasloot zeigt nur Loot an. Falls Sie Karten wünschen, installieren Sie 'Atlas' oder 'Alphamap'.";
    AL["Back"] = "Zurück";
    ...
    AL["If checked, AtlasLoot search item names for a partial match."] =
    "Lässt AtlasLoot die Itemnamen mit teilweisen Übereinstimmungen durchsuchen.";
    ...
    AL[" seconds before you can send a new Wishlist to "] =
    " Sekunden warten bis Sie einen neuen Wunschzettel schicken können an ";
    AL["Cancel"] = "Abbrechen";
    AL["Delete Wishlist %s?"] = "Wunschzettel %s löschen?";
    AL["%s sends you a Wishlist. Accept?"] = "%s sendet einen Wunschzettel. Annehmen?";
    AL[" tried to send you a Wishlist. Rejected because you are in combat."] =
    " hat versucht einen Wunschzettel zu senden. Wegen Kampf abgelehnt.";
    ...
    AL[".  Right click on any other item to refresh the loot page."] =
    ".  Rechtsklicken Sie ein anderes Item um die Seite zu aktualisieren.";

    -- Incomplete Table Registry error message
    AL[" not listed in loot table registry, please report this message to the AtlasLoot forums at http://www.atlasloot.net"] =
    " nicht im Loot-Tabellen Register gelistet, bitte melde diese Nachricht im AtlasLoot Forum unter http://www.atlasloot.net";

    -- LoD Module disabled or missing
    AL[" is unavailable, the following load on demand module is required: "] =
    " ist nicht verfügbar, das folgende Modul wird benötigt: ";

    -- LoD Module load sequence could not be completed
    AL["Status of the following module could not be determined: "] =
    "Status von folgendem Modul konnte nicht festgestellt werden: ";

    -- LoD Module required has loaded, but loot table is missing
    AL[" could not be accessed, the following module may be out of date: "] =
    " konnte nicht erreicht werden, das folgende Modul könnte veraltet sein: ";
    ...
    -- First time user
    AL["Welcome to Atlasloot Enhanced.  Please take a moment to set your preferences."] =
    "Willkommen zu Atlasloot Enhanced!  Bitte nimm Dir einen Moment Zeit, um die Einstellungen festzulegen";
    ...
    "Willkommen zu Atlasloot Enhanced!  Bitte nimm dir einen Moment Zeit, um die Einstellungen für Tooltips und Chatlinks festzulegen.\nWenn du später etwas ändern willst, kannst du den Optionsbildschirm mit /atlasloot aufrufen.";
    AL["Setup"] = "Optionen";

    -- Old Atlas Detected
    AL["It has been detected that your version of Atlas does not match the version that Atlasloot is tuned for ("] =
    "Atlasloot hat festgestellt, dass die Version von Atlas, die du benutzt, nicht der Version entspricht für die Atlasloot konzipiert ist(";
    AL[").  Depending on changes, there may be the occasional error, so please visit http://www.atlasmod.com as soon as possible to update."] =
    "). Dadurch können (schwere) Fehler auftreten! Bitte besuch so schnell wie möglich http://www.atlasmod.com und lad dir die neuste Atlas Version runter.";
    -- AL["OK"] = "OK";
    AL["Incompatible Atlas Detected"] = "Nicht kompatibles Atlas gefunden";

    -- Unsafe item tooltip
    AL["Unsafe Item"] = "Unsicheres Item";
    AL["This item is not available on your server or your battlegroup yet."] =
    "Dieses Item ist auf deinem Server bzw. deinem Realmpool nicht verfügbar";
    AL["You can right-click to attempt to query the server.  You may be disconnected."] =
    "Mit einem Rechtsklick wird der\nServer nach dem Item abgefragt, dabei\nkönnte die Verbindung unterbrochen werden.";
end
