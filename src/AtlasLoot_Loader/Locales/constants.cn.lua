...
if AL then
    ...
    "如果启用了 AtlasLootFu，单击小地图按钮，或像是 Titan 或者 FuBar 上另外生成的按钮。	最后，你可以输入“/al”在聊天窗口。";
    ...
    "最后的补丁更新或服务器重启，没有见过的物品不安全物品会有一个红色边框在物品图标周围用来标记。右击这些物品并移动鼠标回到该物品，或者点击拾取页面下方的“服务器查询”按钮。";
    ...
    "Ctrl+点击物品。有时试衣间窗口会隐藏在 Atlas 或 AtlasLoot 窗口之后，所以如果看上去没有任何变化请移动 Atlas 或 AtlasLoot 窗口让你看到他们。";
    ...
    AL["Ctrl+Alt+Left Click any item to add it to the wishlist."] = "Ctrl+Alt+左键点击任何物品将其添加到愿望列表。";
    ...
    "在愿望列表界面上，只需Ctrl+Alt+左键点击物品即可删除。";
    AL["How to open an item in LootDb:"] = "如何在LootDb中打开物品：";
    AL["Alt+Left Click any item to open it in LootDb."] = "Alt+左键点击任何物品在LootDb中打开。";
    ...
    "单击愿望列表上的任何物品，可以跳转到该物品的拾取页面上。	此外，拾取页面上的任何物品的已经在你的愿望列表时会被标记一颗黄色星星。";
    ...
    "使用选项菜单上的重置按钮，或输入“/al reset”在聊天窗口。";
    ...
    "这仅是一个掉落浏览。要想同时查看地图，请安装 Atlas 或 Alphamap。";
    AL["Back"] = "返回";
    AL["Level 60"] = "等级60";
    AL["Level 70"] = "等级70";
    AL["Level 80"] = "等级80";
    ...
    " 没有被列出掉落表格，请将该错误信息发送到 AtlasLoot 官方论坛：http://www.atlasloot.net。";
    ...
    "欢迎使用 AtlasLoot Enhanced。请用一点时间设置属性。";
    ...
    "）不符。该情况下可能会频繁出现插件错误信息。鉴于此，请您立刻访问 http://www.atlasmod.com 更新您的 Atlas 版本。";
    AL["OK"] = "确定";
