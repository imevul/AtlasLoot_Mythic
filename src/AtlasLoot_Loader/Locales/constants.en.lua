...
if AL then
    ...
    AL["Ctrl+Alt+Left Click any item to add it to the wishlist."] = true;
    ...
    AL["While on the wishlist screen, just Ctrl+Alt+Left Click on an item to delete it."] = true;
    AL["How to open an item in LootDb:"] = true;
    AL["Alt+Left Click any item to open it in LootDb."] = true;
