...
AtlasLoot_Data["AzjolNerubKrikthirTheGatewatcher"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["AhnkahetElderNadox"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["AhnkahetPrinceTaldaram"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["AhnkahetJedogaShadowseeker"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["AhnkahetHeraldVolazj"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["DrakTharonKeepNovosTheSummoner"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["DrakTharonKeepTheProphetTharonja"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["GundrakEckTheFerocious"] = {
	["Heroic"] = {
		{
...
AtlasLoot_Data["GundrakDrakkariColossus"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfStoneMaidenOfGrief"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfStoneTribunalOfTheAges"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfStoneSjonnirTheIronshaper"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfLightningGeneralBjarngrim"] = {
	["Normal"] = {
		{
	...
	["Normal"] = {
		{
			...
			{ 2, 39617, "", "=q4=Heroes' Scourgeborne Battleplate", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 3, 39618, "", "=q4=Heroes' Scourgeborne Gauntlets", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 4, 39620, "", "=q4=Heroes' Scourgeborne Legplates", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 6, 0, "spell_deathknight_bloodpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Tanking"]};
			{ 7, 39623, "", "=q4=Heroes' Scourgeborne Chestguard", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 8, 39624, "", "=q4=Heroes' Scourgeborne Handguards", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 9, 39626, "", "=q4=Heroes' Scourgeborne Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 16, 0, "spell_deathknight_classicon", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"]};
			{ 17, 40781, "", "=q4=Hateful Gladiator's Dreadplate Chestpiece", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 18, 40803, "", "=q4=Hateful Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 19, 40841, "", "=q4=Hateful Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
		};
		{
			{ 1, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 2, 39547, "", "=q4=Heroes' Dreamwalker Vestments", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 3, 39544, "", "=q4=Heroes' Dreamwalker Gloves", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 4, 39546, "", "=q4=Heroes' Dreamwalker Trousers", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 6, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 7, 39554, "", "=q4=Heroes' Dreamwalker Raiments", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 8, 39557, "", "=q4=Heroes' Dreamwalker Handgrips", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 9, 39555, "", "=q4=Heroes' Dreamwalker Legguards", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 11, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 12, 39538, "", "=q4=Heroes' Dreamwalker Robe", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 13, 39543, "", "=q4=Heroes' Dreamwalker Handguards", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 14, 39539, "", "=q4=Heroes' Dreamwalker Leggings", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 16, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 17, 41314, "", "=q4=Hateful Gladiator's Wyrmhide Robes", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 18, 41291, "", "=q4=Hateful Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 19, 41302, "", "=q4=Hateful Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 21, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 22, 41659, "", "=q4=Hateful Gladiator's Dragonhide Robes", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 23, 41771, "", "=q4=Hateful Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 24, 41665, "", "=q4=Hateful Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 26, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 27, 41308, "", "=q4=Hateful Gladiator's Kodohide Robes", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 28, 41284, "", "=q4=Hateful Gladiator's Kodohide Gloves", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 29, 41296, "", "=q4=Hateful Gladiator's Kodohide Legguards", "=ds=#s11#, #a2#", "", "0.99%"};
		};
		{
			{ 1, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 2, 39579, "", "=q4=Heroes' Crypstalker Tunic", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 3, 39582, "", "=q4=Heroes' Crypstalker Handguards", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 4, 39580, "", "=q4=Heroes' Crypstalker Legguards", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 6, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 7, 39492, "", "=q4=Heroes' Frostfire Robe", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 8, 39495, "", "=q4=Heroes' Frostfire Gloves", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 9, 39493, "", "=q4=Heroes' Frostfire Leggings", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 16, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 17, 41085, "", "=q4=Hateful Gladiator's Chain Armor", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 18, 41141, "", "=q4=Hateful Gladiator's Chain Gauntlets", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 19, 41203, "", "=q4=Hateful Gladiator's Chain Leggings", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 21, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 22, 41950, "", "=q4=Hateful Gladiator's Silk Raiment", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 23, 41969, "", "=q4=Hateful Gladiator's Silk Handguards", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 24, 41957, "", "=q4=Hateful Gladiator's Silk Trousers", "=ds=#s11#, #a1#", "", "0.99%"};
		};
		{
			{ 1, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 2, 39629, "", "=q4=Heroes' Redemption Tunic", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 3, 39632, "", "=q4=Heroes' Redemption Gloves", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 4, 39630, "", "=q4=Heroes' Redemption Greaves", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 6, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 7, 39633, "", "=q4=Heroes' Redemption Chestpiece", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 8, 39634, "", "=q4=Heroes' Redemption Gauntlets", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 9, 39636, "", "=q4=Heroes' Redemption Legplates", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 11, 0, "spell_holy_devotionaura", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Protection"]};
			{ 12, 39638, "", "=q4=Heroes' Redemption Breastplate", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 13, 39639, "", "=q4=Heroes' Redemption Handguards", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 14, 39641, "", "=q4=Heroes' Redemption Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 16, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 17, 40904, "", "=q4=Hateful Gladiator's Ornamented Chestguard", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 18, 40925, "", "=q4=Hateful Gladiator's Ornamented Gloves", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 19, 40937, "", "=q4=Hateful Gladiator's Ornamented Legplates", "=ds=#s11#, #a4#", "", "0.99%"}; 
			{ 21, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 22, 40782, "", "=q4=Hateful Gladiator's Scaled Chestpiece", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 23, 40802, "", "=q4=Hateful Gladiator's Scaled Gauntlets", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 24, 40842, "", "=q4=Hateful Gladiator's Scaled Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
		};
		{
			{ 1, 0, "spell_holy_guardianspirit", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Holy"]};
			{ 2, 39515, "", "=q4=Heroes' Robe of Faith", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 3, 39519, "", "=q4=Heroes' Gloves of Faith", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 4, 39517, "", "=q4=Heroes' Leggings of Faith", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 6, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 7, 39523, "", "=q4=Heroes' Raiments of Faith", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 8, 39530, "", "=q4=Heroes' Handwraps of Faith", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 9, 39528, "", "=q4=Heroes' Pants of Faith", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 11, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 12, 39558, "", "=q4=Heroes' Bonescythe Breastplate", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 13, 39560, "", "=q4=Heroes' Bonescythe Gauntlets", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 14, 39564, "", "=q4=Heroes' Bonescythe Legplates", "=ds=#s11#, #a2#", "", "0.99%"};
			{ 16, 0, "spell_holy_powerwordshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Discipline"]};
			{ 17, 41857, "", "=q4=Hateful Gladiator's Mooncloth Robe", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 18, 41872, "", "=q4=Hateful Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 19, 41862, "", "=q4=Hateful Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 21, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 22, 41919, "", "=q4=Hateful Gladiator's Satin Robe", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 23, 41938, "", "=q4=Hateful Gladiator's Satin Gloves", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 24, 41925, "", "=q4=Hateful Gladiator's Satin Leggings", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 26, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 27, 41648, "", "=q4=Hateful Gladiator's Leather Tunic", "=ds=#s5#, #a2#", "", "0.99%"};
			{ 28, 41765, "", "=q4=Hateful Gladiator's Leather Gloves", "=ds=#s9#, #a2#", "", "0.99%"};
			{ 29, 41653, "", "=q4=Hateful Gladiator's Leather Legguards", "=ds=#s11#, #a2#", "", "0.99%"};
		};
		{
			{ 1, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 2, 39592, "", "=q4=Heroes' Earthshatter Hauberk", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 3, 39593, "", "=q4=Heroes' Earthshatter Gloves", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 4, 39595, "", "=q4=Heroes' Earthshatter Kilt", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 6, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 7, 39597, "", "=q4=Heroes' Earthshatter Chestguard", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 8, 39601, "", "=q4=Heroes' Earthshatter Grips", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 9, 39603, "", "=q4=Heroes' Earthshatter War-Kilt", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 11, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 12, 39588, "", "=q4=Heroes' Earthshatter Tunic", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 13, 39591, "", "=q4=Heroes' Earthshatter Handguards", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 14, 39589, "", "=q4=Heroes' Earthshatter Legguards", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 16, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 17, 40989, "", "=q4=Hateful Gladiator's Mail Armor", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 18, 41005, "", "=q4=Hateful Gladiator's Mail Gauntlets", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 19, 41031, "", "=q4=Hateful Gladiator's Mail Leggings", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 21, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 22, 41079, "", "=q4=Hateful Gladiator's Linked Armor", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 23, 41135, "", "=q4=Hateful Gladiator's Linked Gauntlets", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 24, 41162, "", "=q4=Hateful Gladiator's Linked Leggings", "=ds=#s11#, #a3#", "", "0.99%"};
			{ 26, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 27, 40988, "", "=q4=Hateful Gladiator's Ringmail Armor", "=ds=#s5#, #a3#", "", "0.99%"};
			{ 28, 40999, "", "=q4=Hateful Gladiator's Ringmail Gauntlets", "=ds=#s9#, #a3#", "", "0.99%"};
			{ 29, 41025, "", "=q4=Hateful Gladiator's Ringmail Leggings", "=ds=#s11#, #a3#", "", "0.99%"};
		};
		{
			{ 1, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 2, 39497, "", "=q4=Heroes' Plagueheart Robe", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 3, 39500, "", "=q4=Heroes' Plagueheart Gloves", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 4, 39498, "", "=q4=Heroes' Plagueheart Leggings", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 6, 0, "ability_warrior_innerrage", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["DPS"]};
			{ 7, 39606, "", "=q4=Heroes' Dreadnaught Battleplate", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 8, 39609, "", "=q4=Heroes' Dreadnaught Gauntlets", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 9, 39607, "", "=q4=Heroes' Dreadnaught Legplates", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 11, 0, "ability_warrior_defensivestance", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Protection"]};
			{ 12, 39611, "", "=q4=Heroes' Dreadnaught Breastplate", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 13, 39622, "", "=q4=Heroes' Dreadnaught Handguards", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 14, 39612, "", "=q4=Heroes' Dreadnaught Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
			{ 16, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 17, 42001, "", "=q4=Hateful Gladiator's Felweave Raiment", "=ds=#s5#, #a1#", "", "0.99%"};
			{ 18, 42015, "", "=q4=Hateful Gladiator's Felweave Handguards", "=ds=#s9#, #a1#", "", "0.99%"};
			{ 19, 42003, "", "=q4=Hateful Gladiator's Felweave Trousers", "=ds=#s11#, #a1#", "", "0.99%"};
			{ 21, 0, "inv_sword_27", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]};
			{ 22, 40783, "", "=q4=Hateful Gladiator's Plate Chestpiece", "=ds=#s5#, #a4#", "", "0.99%"};
			{ 23, 40801, "", "=q4=Hateful Gladiator's Plate Gauntlets", "=ds=#s9#, #a4#", "", "0.99%"};
			{ 24, 40840, "", "=q4=Hateful Gladiator's Plate Legguards", "=ds=#s11#, #a4#", "", "0.99%"};
		};
	};
	["25Man"] = {
		{
			{ 1, 0, "spell_deathknight_frostpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["DPS"]};
			{ 2, 40550, "", "=q4=Valorous Scourgeborne Battleplate", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 3, 40552, "", "=q4=Valorous Scourgeborne Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 4, 40556, "", "=q4=Valorous Scourgeborne Legplates", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 6, 0, "spell_deathknight_bloodpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Tanking"]};
			{ 7, 40559, "", "=q4=Valorous Scourgeborne Chestguard", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 8, 40563, "", "=q4=Valorous Scourgeborne Handguards", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 9, 40567, "", "=q4=Valorous Scourgeborne Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 16, 0, "spell_deathknight_classicon", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"]};
			{ 17, 40784, "", "=q4=Deadly Gladiator's Dreadplate Chestpiece", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 18, 40806, "", "=q4=Deadly Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 19, 40845, "", "=q4=Deadly Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
		};
		{
			{ 1, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 2, 40469, "", "=q4=Valorous Dreamwalker Vestments", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 3, 40466, "", "=q4=Valorous Dreamwalker Gloves", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 4, 40468, "", "=q4=Valorous Dreamwalker Trousers", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 6, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 7, 40471, "", "=q4=Valorous Dreamwalker Raiments", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 8, 40472, "", "=q4=Valorous Dreamwalker Handgrips", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 9, 40493, "", "=q4=Valorous Dreamwalker Legguards", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 11, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 12, 40463, "", "=q4=Valorous Dreamwalker Robe", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 13, 40460, "", "=q4=Valorous Dreamwalker Handguards", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 14, 40462, "", "=q4=Valorous Dreamwalker Leggings", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 16, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 17, 41315, "", "=q4=Deadly Gladiator's Wyrmhide Robes", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 18, 41292, "", "=q4=Deadly Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 19, 41303, "", "=q4=Deadly Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 21, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 22, 41660, "", "=q4=Deadly Gladiator's Dragonhide Robes", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 23, 41772, "", "=q4=Deadly Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 24, 41666, "", "=q4=Deadly Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 26, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 27, 41309, "", "=q4=Deadly Gladiator's Kodohide Robes", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 28, 41286, "", "=q4=Deadly Gladiator's Kodohide Gloves", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 29, 41297, "", "=q4=Deadly Gladiator's Kodohide Legguards", "=ds=#s11#, #a2#", "", "0.95%"};
		};
		{
			{ 1, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 2, 40503, "", "=q4=Valorous Crypstalker Tunic", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 3, 40504, "", "=q4=Valorous Crypstalker Handguards", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 4, 40506, "", "=q4=Valorous Crypstalker Legguards", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 6, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 7, 40418, "", "=q4=Valorous Frostfire Robe", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 8, 40415, "", "=q4=Valorous Frostfire Gloves", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 9, 40417, "", "=q4=Valorous Frostfire Leggings", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 16, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 17, 41086, "", "=q4=Deadly Gladiator's Chain Armor", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 18, 41142, "", "=q4=Deadly Gladiator's Chain Gauntlets", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 19, 41204, "", "=q4=Deadly Gladiator's Chain Leggings", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 21, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 22, 41951, "", "=q4=Deadly Gladiator's Silk Raiment", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 23, 41970, "", "=q4=Deadly Gladiator's Silk Handguards", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 24, 41958, "", "=q4=Deadly Gladiator's Silk Trousers", "=ds=#s11#, #a1#", "", "0.95%"};

		};
		{
			{ 1, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 2, 40569, "", "=q4=Valorous Redemption Tunic", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 3, 40570, "", "=q4=Valorous Redemption Gloves", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 4, 40572, "", "=q4=Valorous Redemption Greaves", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 6, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 7, 40574, "", "=q4=Valorous Redemption Chestpiece", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 8, 40575, "", "=q4=Valorous Redemption Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 9, 40577, "", "=q4=Valorous Redemption Legplates", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 11, 0, "spell_holy_devotionaura", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Protection"]};
			{ 12, 40579, "", "=q4=Valorous Redemption Breastplate", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 13, 40580, "", "=q4=Valorous Redemption Handguards", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 14, 40583, "", "=q4=Valorous Redemption Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 16, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 17, 40905, "", "=q4=Deadly Gladiator's Ornamented Chestguard", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 18, 40926, "", "=q4=Deadly Gladiator's Ornamented Gloves", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 19, 40938, "", "=q4=Deadly Gladiator's Ornamented Legplates", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 21, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 22, 40785, "", "=q4=Deadly Gladiator's Scaled Chestpiece", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 23, 40805, "", "=q4=Deadly Gladiator's Scaled Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 24, 40846, "", "=q4=Deadly Gladiator's Scaled Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
		};
		{
			{ 1, 0, "spell_holy_guardianspirit", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Holy"]};
			{ 2, 40449, "", "=q4=Valorous Robe of Faith", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 3, 40445, "", "=q4=Valorous Gloves of Faith", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 4, 40448, "", "=q4=Valorous Leggings of Faith", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 6, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 7, 40458, "", "=q4=Valorous Raiments of Faith", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 8, 40454, "", "=q4=Valorous Handwraps of Faith", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 9, 40457, "", "=q4=Valorous Pants of Faith", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 11, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 12, 40495, "", "=q4=Valorous Bonescythe Breastplate", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 13, 40496, "", "=q4=Valorous Bonescythe Gauntlets", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 14, 40500, "", "=q4=Valorous Bonescythe Legplates", "=ds=#s11#, #a2#", "", "0.95%"};
			{ 16, 0, "spell_holy_powerwordshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Discipline"]};
			{ 17, 41858, "", "=q4=Deadly Gladiator's Mooncloth Robe", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 18, 41873, "", "=q4=Deadly Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 19, 41863, "", "=q4=Deadly Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 21, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 22, 41920, "", "=q4=Deadly Gladiator's Satin Robe", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 23, 41939, "", "=q4=Deadly Gladiator's Satin Gloves", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 24, 41926, "", "=q4=Deadly Gladiator's Satin Leggings", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 26, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 27, 41649, "", "=q4=Deadly Gladiator's Leather Tunic", "=ds=#s5#, #a2#", "", "0.95%"};
			{ 28, 41766, "", "=q4=Deadly Gladiator's Leather Gloves", "=ds=#s9#, #a2#", "", "0.95%"};
			{ 29, 41654, "", "=q4=Deadly Gladiator's Leather Legguards", "=ds=#s11#, #a2#", "", "0.95%"};
		};
		{
			{ 1, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 2, 40514, "", "=q4=Valorous Earthshatter Hauberk", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 3, 40515, "", "=q4=Valorous Earthshatter Gloves", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 4, 40517, "", "=q4=Valorous Earthshatter Kilt", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 6, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 7, 40523, "", "=q4=Valorous Earthshatter Chestguard", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 8, 40520, "", "=q4=Valorous Earthshatter Grips", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 9, 40522, "", "=q4=Valorous Earthshatter War-Kilt", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 11, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 12, 40508, "", "=q4=Valorous Earthshatter Tunic", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 13, 40509, "", "=q4=Valorous Earthshatter Handguards", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 14, 40512, "", "=q4=Valorous Earthshatter Legguards", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 16, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 17, 40991, "", "=q4=Deadly Gladiator's Mail Armor", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 18, 41006, "", "=q4=Deadly Gladiator's Mail Gauntlets", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 19, 41032, "", "=q4=Deadly Gladiator's Mail Leggings", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 21, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 22, 41080, "", "=q4=Deadly Gladiator's Linked Armor", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 23, 41136, "", "=q4=Deadly Gladiator's Linked Gauntlets", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 24, 41198, "", "=q4=Deadly Gladiator's Linked Leggings", "=ds=#s11#, #a3#", "", "0.95%"};
			{ 26, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 27, 40990, "", "=q4=Deadly Gladiator's Ringmail Armor", "=ds=#s5#, #a3#", "", "0.95%"};
			{ 28, 41000, "", "=q4=Deadly Gladiator's Ringmail Gauntlets", "=ds=#s9#, #a3#", "", "0.95%"};
			{ 29, 41026, "", "=q4=Deadly Gladiator's Ringmail Leggings", "=ds=#s11#, #a3#", "", "0.95%"};
		};
		{
			{ 1, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 2, 40423, "", "=q4=Valorous Plagueheart Robe", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 3, 40420, "", "=q4=Valorous Plagueheart Gloves", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 4, 40422, "", "=q4=Valorous Plagueheart Leggings", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 6, 0, "ability_warrior_innerrage", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["DPS"]};
			{ 7, 40525, "", "=q4=Valorous Dreadnaught Battleplate", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 8, 40527, "", "=q4=Valorous Dreadnaught Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 9, 40529, "", "=q4=Valorous Dreadnaught Legplates", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 11, 0, "ability_warrior_defensivestance", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Protection"]};
			{ 12, 40544, "", "=q4=Valorous Dreadnaught Breastplate", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 13, 40545, "", "=q4=Valorous Dreadnaught Handguards", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 14, 40547, "", "=q4=Valorous Dreadnaught Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
			{ 16, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 17, 41997, "", "=q4=Deadly Gladiator's Felweave Raiment", "=ds=#s5#, #a1#", "", "0.95%"};
			{ 18, 42016, "", "=q4=Deadly Gladiator's Felweave Handguards", "=ds=#s9#, #a1#", "", "0.95%"};
			{ 19, 42004, "", "=q4=Deadly Gladiator's Felweave Trousers", "=ds=#s11#, #a1#", "", "0.95%"};
			{ 21, 0, "inv_sword_27", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]};
			{ 22, 40786, "", "=q4=Deadly Gladiator's Plate Chestpiece", "=ds=#s5#, #a4#", "", "0.95%"};
			{ 23, 40804, "", "=q4=Deadly Gladiator's Plate Gauntlets", "=ds=#s9#, #a4#", "", "0.95%"};
			{ 24, 40844, "", "=q4=Deadly Gladiator's Plate Legguards", "=ds=#s11#, #a4#", "", "0.95%"};
		};
	};
	info = {
		name = BabbleBoss["Archavon the Stone Watcher"],
		module = moduleName,
		instance = "VaultOfArchavon",
		menu = "ARCHAVON",
	};
};
...
AtlasLoot_Data["VoAEmalon"] = {
	["Normal"] = {
		{
			{ 1, 0, "spell_deathknight_frostpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["DPS"]};
			{ 2, 45341, "", "=q4=Valorous Darkruned Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 3, 45343, "", "=q4=Valorous Darkruned Legplates", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 5, 0, "spell_deathknight_bloodpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Tanking"]};
			{ 6, 45337, "", "=q4=Valorous Darkruned Handguards", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 7, 45338, "", "=q4=Valorous Darkruned Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 16, 0, "spell_deathknight_classicon", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"]};
			{ 17, 40806, "", "=q4=Deadly Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 18, 40845, "", "=q4=Deadly Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
		};
		{
			{ 1, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 2, 45351, "", "=q4=Valorous Nightsong Gloves", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 3, 45353, "", "=q4=Valorous Nightsong Trousers", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 5, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 6, 45355, "", "=q4=Valorous Nightsong Handgrips", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 7, 45357, "", "=q4=Valorous Nightsong Legguards", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 9, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 10, 45345, "", "=q4=Valorous Nightsong Handguards", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 11, 45347, "", "=q4=Valorous Nightsong Leggings", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 16, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 17, 41292, "", "=q4=Deadly Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 18, 41303, "", "=q4=Deadly Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 20, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 21, 41772, "", "=q4=Deadly Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 22, 41666, "", "=q4=Deadly Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 24, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 25, 41286, "", "=q4=Deadly Gladiator's Kodohide Gloves", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 26, 41297, "", "=q4=Deadly Gladiator's Kodohide Legguards", "=ds=#s11#, #a2#", "", "0.87%"};
		};
		{
			{ 1, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 2, 45360, "", "=q4=Valorous Scourgestalker Handguards", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 3, 45362, "", "=q4=Valorous Scourgestalker Legguards", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 5, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 6, 46131, "", "=q4=Valorous Kirin Tor Gauntlets", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 7, 45367, "", "=q4=Valorous Kirin Tor Leggings", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 16, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 17, 41142, "", "=q4=Deadly Gladiator's Chain Gauntlets", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 18, 41204, "", "=q4=Deadly Gladiator's Chain Leggings", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 20, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 21, 41970, "", "=q4=Deadly Gladiator's Silk Handguards", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 22, 41958, "", "=q4=Deadly Gladiator's Silk Trousers", "=ds=#s11#, #a1#", "", "0.87%"};
		};
		{
			{ 1, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 2, 45370, "", "=q4=Valorous Aegis Gloves", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 3, 45371, "", "=q4=Valorous Aegis Greaves", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 5, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 6, 45376, "", "=q4=Valorous Aegis Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 7, 45379, "", "=q4=Valorous Aegis Legplates", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 9, 0, "spell_holy_devotionaura", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Protection"]};
			{ 10, 45383, "", "=q4=Valorous Aegis Handguards", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 11, 45384, "", "=q4=Valorous Aegis Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 16, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 17, 40926, "", "=q4=Deadly Gladiator's Ornamented Gloves", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 18, 40938, "", "=q4=Deadly Gladiator's Ornamented Legplates", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 20, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 21, 40805, "", "=q4=Deadly Gladiator's Scaled Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 22, 40846, "", "=q4=Deadly Gladiator's Scaled Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
		};
		{
			{ 1, 0, "spell_holy_guardianspirit", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Holy"]};
			{ 2, 45387, "", "=q4=Valorous Gloves of Sanctification", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 3, 45388, "", "=q4=Valorous Leggings of Sanctification", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 5, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 6, 45392, "", "=q4=Valorous Handwraps of Sanctification", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 7, 45394, "", "=q4=Valorous Pants of Sanctification", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 9, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 10, 45397, "", "=q4=Valorous Terrorblade Gauntlets", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 11, 45399, "", "=q4=Valorous Terrorblade Legplates", "=ds=#s11#, #a2#", "", "0.87%"};
			{ 16, 0, "spell_holy_powerwordshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Discipline"]};
			{ 17, 41873, "", "=q4=Deadly Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 18, 41863, "", "=q4=Deadly Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 20, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 21, 41939, "", "=q4=Deadly Gladiator's Satin Gloves", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 22, 41926, "", "=q4=Deadly Gladiator's Satin Leggings", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 24, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 25, 41766, "", "=q4=Deadly Gladiator's Leather Gloves", "=ds=#s9#, #a2#", "", "0.87%"};
			{ 26, 41654, "", "=q4=Deadly Gladiator's Leather Legguards", "=ds=#s11#, #a2#", "", "0.87%"};
		};
		{
			{ 1, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 2, 45406, "", "=q4=Valorous Worldbreaker Gloves", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 3, 45409, "", "=q4=Valorous Worldbreaker Kilt", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 5, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 6, 45414, "", "=q4=Valorous Worldbreaker Grips", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 7, 45416, "", "=q4=Valorous Worldbreaker War-Kilt", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 9, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 10, 45401, "", "=q4=Valorous Worldbreaker Handguards", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 11, 45403, "", "=q4=Valorous Worldbreaker Legguards", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 16, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 17, 41006, "", "=q4=Deadly Gladiator's Mail Gauntlets", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 18, 41032, "", "=q4=Deadly Gladiator's Mail Leggings", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 20, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 21, 41136, "", "=q4=Deadly Gladiator's Linked Gauntlets", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 22, 41198, "", "=q4=Deadly Gladiator's Linked Leggings", "=ds=#s11#, #a3#", "", "0.87%"};
			{ 24, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 25, 41000, "", "=q4=Deadly Gladiator's Ringmail Gauntlets", "=ds=#s9#, #a3#", "", "0.87%"};
			{ 26, 41026, "", "=q4=Deadly Gladiator's Ringmail Leggings", "=ds=#s11#, #a3#", "", "0.87%"};
		};
		{
			{ 1, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 2, 45419, "", "=q4=Valorous Deathbringer Gloves", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 3, 45420, "", "=q4=Valorous Deathbringer Leggings", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 5, 0, "ability_warrior_innerrage", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["DPS"]};
			{ 6, 45430, "", "=q4=Valorous Siegebreaker Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 7, 45432, "", "=q4=Valorous Siegebreaker Legplates", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 9, 0, "ability_warrior_defensivestance", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Protection"]};
			{ 10, 45426, "", "=q4=Valorous Siegebreaker Handguards", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 11, 45427, "", "=q4=Valorous Siegebreaker Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
			{ 16, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 17, 42016, "", "=q4=Deadly Gladiator's Felweave Handguards", "=ds=#s9#, #a1#", "", "0.87%"};
			{ 18, 42004, "", "=q4=Deadly Gladiator's Felweave Trousers", "=ds=#s11#, #a1#", "", "0.87%"};
			{ 20, 0, "inv_sword_27", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]};
			{ 21, 40804, "", "=q4=Deadly Gladiator's Plate Gauntlets", "=ds=#s9#, #a4#", "", "0.87%"};
			{ 22, 40844, "", "=q4=Deadly Gladiator's Plate Legguards", "=ds=#s11#, #a4#", "", "0.87%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Cloth"]};
			{ 2, 41908, "", "=q4=Deadly Gladiator's Cuffs of Dominance", "=ds=#s8#, #a1#", "", "0.87%"};
			{ 3, 41897, "", "=q4=Deadly Gladiator's Cord of Dominance", "=ds=#s10#, #a1#", "", "0.87%"};
			{ 4, 41902, "", "=q4=Deadly Gladiator's Treads of Dominance", "=ds=#s12#, #a1#", "", "0.87%"};
			{ 6, 41892, "", "=q4=Deadly Gladiator's Cuffs of Salvation", "=ds=#s8#, #a1#", "", "0.87%"};
			{ 7, 41880, "", "=q4=Deadly Gladiator's Cord of Salvation", "=ds=#s10#, #a1#", "", "0.87%"};
			{ 8, 41884, "", "=q4=Deadly Gladiator's Treads of Salvation", "=ds=#s12#, #a1#", "", "0.87%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Leather"]};
			{ 17, 41639, "", "=q4=Deadly Gladiator's Armwraps of Dominance", "=ds=#s8#, #a2#", "", "0.87%"};
			{ 18, 41629, "", "=q4=Deadly Gladiator's Belt of Dominance", "=ds=#s10#, #a2#", "", "0.87%"};
			{ 19, 41634, "", "=q4=Deadly Gladiator's Boots of Dominance", "=ds=#s12#, #a2#", "", "0.87%"};
			{ 21, 41624, "", "=q4=Deadly Gladiator's Armwraps of Salvation", "=ds=#s8#, #a2#", "", "0.87%"};
			{ 22, 41616, "", "=q4=Deadly Gladiator's Belt of Salvation", "=ds=#s10#, #a2#", "", "0.87%"};
			{ 23, 41620, "", "=q4=Deadly Gladiator's Boots of Salvation", "=ds=#s12#, #a2#", "", "0.87%"};
			{ 25, 41839, "", "=q4=Deadly Gladiator's Armwraps of Triumph", "=ds=#s8#, #a2#", "", "0.87%"};
			{ 26, 41831, "", "=q4=Deadly Gladiator's Belt of Triumph", "=ds=#s10#, #a2#", "", "0.87%"};
			{ 27, 41835, "", "=q4=Deadly Gladiator's Boots of Triumph", "=ds=#s12#, #a2#", "", "0.87%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Mail"]};
			{ 2, 41064, "", "=q4=Deadly Gladiator's Wristguards of Dominance", "=ds=#s8#, #a3#", "", "0.87%"};
			{ 3, 41069, "", "=q4=Deadly Gladiator's Waistguard of Dominance", "=ds=#s10#, #a3#", "", "0.87%"};
			{ 4, 41074, "", "=q4=Deadly Gladiator's Sabatons of Dominance", "=ds=#s12#, #a3#", "", "0.87%"};
			{ 6, 41059, "", "=q4=Deadly Gladiator's Wristguards of Salvation", "=ds=#s8#, #a3#", "", "0.87%"};
			{ 7, 41048, "", "=q4=Deadly Gladiator's Waistguard of Salvation", "=ds=#s10#, #a3#", "", "0.87%"};
			{ 8, 41054, "", "=q4=Deadly Gladiator's Sabatons of Salvation", "=ds=#s12#, #a3#", "", "0.87%"};
			{ 10, 41224, "", "=q4=Deadly Gladiator's Wristguards of Triumph", "=ds=#s8#, #a3#", "", "0.87%"};
			{ 11, 41234, "", "=q4=Deadly Gladiator's Waistguard of Triumph", "=ds=#s10#, #a3#", "", "0.87%"};
			{ 12, 41229, "", "=q4=Deadly Gladiator's Sabatons of Triumph", "=ds=#s12#, #a3#", "", "0.87%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Plate"]};
			{ 17, 40982, "", "=q4=Deadly Gladiator's Bracers of Salvation", "=ds=#s8#, #a4#", "", "0.87%"};
			{ 18, 40974, "", "=q4=Deadly Gladiator's Girdle of Salvation", "=ds=#s10#, #a4#", "", "0.87%"};
			{ 19, 40975, "", "=q4=Deadly Gladiator's Greaves of Salvation", "=ds=#s12#, #a4#", "", "0.87%"};
			{ 21, 40888, "", "=q4=Deadly Gladiator's Bracers of Triumph", "=ds=#s8#, #a4#", "", "0.87%"};
			{ 22, 40879, "", "=q4=Deadly Gladiator's Girdle of Triumph", "=ds=#s10#, #a4#", "", "0.87%"};
			{ 23, 40880, "", "=q4=Deadly Gladiator's Greaves of Triumph", "=ds=#s12#, #a4#", "", "0.87%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Back"]};
			{ 2, 42064, "", "=q4=Deadly Gladiator's Cloak of Ascendancy", "=ds=#s4#", "", "0.87%"};
			{ 3, 42066, "", "=q4=Deadly Gladiator's Cloak of Deliverance", "=ds=#s4#", "", "0.87%"};
			{ 4, 42062, "", "=q4=Deadly Gladiator's Cloak of Dominance", "=ds=#s4#", "", "0.87%"};
			{ 5, 42065, "", "=q4=Deadly Gladiator's Cloak of Salvation", "=ds=#s4#", "", "0.87%"};
			{ 6, 42063, "", "=q4=Deadly Gladiator's Cloak of Subjugation", "=ds=#s4#", "", "0.87%"};
			{ 7, 42067, "", "=q4=Deadly Gladiator's Cloak of Triumph", "=ds=#s4#", "", "0.87%"};
			{ 8, 42068, "", "=q4=Deadly Gladiator's Cloak of Victory", "=ds=#s4#", "", "0.87%"};
			{ 10, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Ring"]};
			{ 11, 42114, "", "=q4=Deadly Gladiator's Band of Ascendancy", "=ds=#s13#", "", "0.87%"};
			{ 12, 42115, "", "=q4=Deadly Gladiator's Band of Victory", "=ds=#s13#", "", "0.87%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Neck"]};
			{ 17, 42030, "", "=q4=Deadly Gladiator's Pendant of Ascendancy", "=ds=#s2#", "", "0.87%"};
			{ 18, 42032, "", "=q4=Deadly Gladiator's Pendant of Deliverance", "=ds=#s2#", "", "0.87%"};
			{ 19, 42029, "", "=q4=Deadly Gladiator's Pendant of Dominance", "=ds=#s2#", "", "0.87%"};
			{ 20, 42033, "", "=q4=Deadly Gladiator's Pendant of Salvation", "=ds=#s2#", "", "0.87%"};
			{ 21, 42031, "", "=q4=Deadly Gladiator's Pendant of Subjugation", "=ds=#s2#", "", "0.87%"};
			--{ 22, 42027, "", "=q4=Deadly Gladiator's Pendant of Triumph", "=ds=#s2#", "", "0.87%"}; item not in DB as droppable
			{ 22, 42028, "", "=q4=Deadly Gladiator's Pendant of Victory", "=ds=#s2#", "", "0.87%"};
		};
	};
	["25Man"] = {
		{
			{ 1, 0, "spell_deathknight_frostpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["DPS"]};
			{ 2, 46113, "", "=q4=Conqueror's Darkruned Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 3, 46116, "", "=q4=Conqueror's Darkruned Legplates", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 5, 0, "spell_deathknight_bloodpresence", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Tanking"]};
			{ 6, 46119, "", "=q4=Conqueror's Darkruned Handguards", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 7, 46121, "", "=q4=Conqueror's Darkruned Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 16, 0, "spell_deathknight_classicon", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"]};
			{ 17, 40809, "", "=q4=Furious Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 18, 40848, "", "=q4=Furious Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
		};
		{
			{ 1, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 2, 46189, "", "=q4=Conqueror's Nightsong Gloves", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 3, 46192, "", "=q4=Conqueror's Nightsong Trousers", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 5, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 6, 46158, "", "=q4=Conqueror's Nightsong Handgrips", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 7, 46160, "", "=q4=Conqueror's Nightsong Legguards", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 9, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 10, 46183, "", "=q4=Conqueror's Nightsong Handguards", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 11, 46185, "", "=q4=Conqueror's Nightsong Leggings", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 16, 0, "spell_nature_starfall", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Balance"]};
			{ 17, 41293, "", "=q4=Furious Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 18, 41304, "", "=q4=Furious Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 20, 0, "ability_racial_bearform", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Feral"]};
			{ 21, 41773, "", "=q4=Furious Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 22, 41667, "", "=q4=Furious Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 24, 0, "spell_nature_healingtouch", "=q6="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Restoration"]};
			{ 25, 41287, "", "=q4=Furious Gladiator's Kodohide Gloves", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 26, 41298, "", "=q4=Furious Gladiator's Kodohide Legguards", "=ds=#s11#, #a2#", "", "0.86%"};
		};
		{
			{ 1, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 2, 46142, "", "=q4=Conqueror's Scourgestalker Handguards", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 3, 46144, "", "=q4=Conqueror's Scourgestalker Legguards", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 5, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 6, 46132, "", "=q4=Conqueror's Kirin Tor Gauntlets", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 7, 46133, "", "=q4=Conqueror's Kirin Tor Leggings", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 16, 0, "inv_weapon_bow_07", "=q6="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], ""};
			{ 17, 41143, "", "=q4=Furious Gladiator's Chain Gauntlets", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 18, 41205, "", "=q4=Furious Gladiator's Chain Leggings", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 20, 0, "inv_staff_13", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
			{ 21, 41971, "", "=q4=Furious Gladiator's Silk Handguards", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 22, 41959, "", "=q4=Furious Gladiator's Silk Trousers", "=ds=#s11#, #a1#", "", "0.86%"};
		};
		{
			{ 1, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 2, 46179, "", "=q4=Conqueror's Aegis Gloves", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 3, 46181, "", "=q4=Conqueror's Aegis Greaves", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 5, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 6, 46155, "", "=q4=Conqueror's Aegis Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 7, 46153, "", "=q4=Conqueror's Aegis Legplates", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 9, 0, "spell_holy_devotionaura", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Protection"]};
			{ 10, 46174, "", "=q4=Conqueror's Aegis Handguards", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 11, 46176, "", "=q4=Conqueror's Aegis Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 16, 0, "Spell_Holy_HolyBolt", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Holy"]};
			{ 17, 40927, "", "=q4=Furious Gladiator's Ornamented Gloves", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 18, 40939, "", "=q4=Furious Gladiator's Ornamented Legplates", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 20, 0, "Spell_Holy_AuraOfLight", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Retribution"]};
			{ 21, 40808, "", "=q4=Furious Gladiator's Scaled Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 22, 40849, "", "=q4=Furious Gladiator's Scaled Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
		};
		{
			{ 1, 0, "spell_holy_guardianspirit", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Holy"]};
			{ 2, 46188, "", "=q4=Conqueror's Gloves of Sanctification", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 3, 46195, "", "=q4=Conqueror's Leggings of Sanctification", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 5, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 6, 46163, "", "=q4=Conqueror's Handwraps of Sanctification", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 7, 46170, "", "=q4=Conqueror's Pants of Sanctification", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 9, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 10, 46124, "", "=q4=Conqueror's Terrorblade Gauntlets", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 11, 46126, "", "=q4=Conqueror's Terrorblade Legplates", "=ds=#s11#, #a2#", "", "0.86%"};
			{ 16, 0, "spell_holy_powerwordshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Discipline"]};
			{ 17, 41874, "", "=q4=Furious Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 18, 41864, "", "=q4=Furious Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 20, 0, "spell_shadow_shadowwordpain", "=q6="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Shadow"]};
			{ 21, 41940, "", "=q4=Furious Gladiator's Satin Gloves", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 22, 41927, "", "=q4=Furious Gladiator's Satin Leggings", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 24, 0, "inv_throwingknife_04", "=q6="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], ""};
			{ 25, 41767, "", "=q4=Furious Gladiator's Leather Gloves", "=ds=#s9#, #a2#", "", "0.86%"};
			{ 26, 41655, "", "=q4=Furious Gladiator's Leather Legguards", "=ds=#s11#, #a2#", "", "0.86%"};
		};
		{
			{ 1, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 2, 46207, "", "=q4=Conqueror's Worldbreaker Gloves", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 3, 46210, "", "=q4=Conqueror's Worldbreaker Kilt", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 5, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 6, 46200, "", "=q4=Conqueror's Worldbreaker Grips", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 7, 46208, "", "=q4=Conqueror's Worldbreaker War-Kilt", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 9, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 10, 46199, "", "=q4=Conqueror's Worldbreaker Handguards", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 11, 46202, "", "=q4=Conqueror's Worldbreaker Legguards", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 16, 0, "Spell_Nature_Lightning", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Elemental"]};
			{ 17, 41007, "", "=q4=Furious Gladiator's Mail Gauntlets", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 18, 41033, "", "=q4=Furious Gladiator's Mail Leggings", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 20, 0, "spell_nature_lightningshield", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Enhancement"]};
			{ 21, 41137, "", "=q4=Furious Gladiator's Linked Gauntlets", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 22, 41199, "", "=q4=Furious Gladiator's Linked Leggings", "=ds=#s11#, #a3#", "", "0.86%"};
			{ 24, 0, "spell_nature_magicimmunity", "=q6="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Restoration"]};
			{ 25, 41001, "", "=q4=Furious Gladiator's Ringmail Gauntlets", "=ds=#s9#, #a3#", "", "0.86%"};
			{ 26, 41027, "", "=q4=Furious Gladiator's Ringmail Leggings", "=ds=#s11#, #a3#", "", "0.86%"};
		};
		{
			{ 1, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 2, 46135, "", "=q4=Conqueror's Deathbringer Gloves", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 3, 46139, "", "=q4=Conqueror's Deathbringer Leggings", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 5, 0, "ability_warrior_innerrage", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["DPS"]};
			{ 6, 46148, "", "=q4=Conqueror's Siegebreaker Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 7, 46150, "", "=q4=Conqueror's Siegebreaker Legplates", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 9, 0, "ability_warrior_defensivestance", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Protection"]};
			{ 10, 46164, "", "=q4=Conqueror's Siegebreaker Handguards", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 11, 46169, "", "=q4=Conqueror's Siegebreaker Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
			{ 16, 0, "spell_nature_drowsy", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], ""};
			{ 17, 42017, "", "=q4=Furious Gladiator's Felweave Handguards", "=ds=#s9#, #a1#", "", "0.86%"};
			{ 18, 42005, "", "=q4=Furious Gladiator's Felweave Trousers", "=ds=#s11#, #a1#", "", "0.86%"};
			{ 20, 0, "inv_sword_27", "=q6="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]};
			{ 21, 40807, "", "=q4=Furious Gladiator's Plate Gauntlets", "=ds=#s9#, #a4#", "", "0.86%"};
			{ 22, 40847, "", "=q4=Furious Gladiator's Plate Legguards", "=ds=#s11#, #a4#", "", "0.86%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Cloth"]};
			{ 2, 41909, "", "=q4=Furious Gladiator's Cuffs of Dominance",  "=ds=#s8#, #a1#", "", "0.86%"};
			{ 3, 41898, "", "=q4=Furious Gladiator's Cord of Dominance", "=ds=#s10#, #a1#", "", "0.86%"};
			{ 4, 41903, "", "=q4=Furious Gladiator's Slippers of Dominance",  "=ds=#s12#, #a1#", "", "0.86%"};
			{ 6, 41893, "", "=q4=Furious Gladiator's Cuffs of Salvation",  "=ds=#s8#, #a1#", "", "0.86%"};
			{ 7, 41881, "", "=q4=Furious Gladiator's Cord of Salvation",  "=ds=#s10#, #a1#", "", "0.86%"};
			{ 8, 41885, "", "=q4=Furious Gladiator's Slippers of Salvation",  "=ds=#s12#, #a1#", "", "0.86%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Leather"]};
			{ 17, 41640, "", "=q4=Furious Gladiator's Armwraps of Dominance",  "=ds=#s8#, #a2#", "", "0.86%"};
			{ 18, 41630, "", "=q4=Furious Gladiator's Belt of Dominance",  "=ds=#s10#, #a2#", "", "0.86%"};
			{ 19, 41635, "", "=q4=Furious Gladiator's Boots of Dominance",  "=ds=#s12#, #a2#", "", "0.86%"};
			{ 21, 41625, "", "=q4=Furious Gladiator's Armwraps of Salvation",  "=ds=#s8#, #a2#", "", "0.86%"};
			{ 22, 41617, "", "=q4=Furious Gladiator's Belt of Salvation", "=ds=#s10#, #a2#", "", "0.86%"};
			{ 23, 41621, "", "=q4=Furious Gladiator's Boots of Salvation",  "=ds=#s12#, #a2#", "", "0.86%"};
			{ 25, 41840, "", "=q4=Furious Gladiator's Armwraps of Triumph",  "=ds=#s8#, #a2#", "", "0.86%"};
			{ 26, 41832, "", "=q4=Furious Gladiator's Belt of Triumph",  "=ds=#s10#, #a2#", "", "0.86%"};
			{ 27, 41836, "", "=q4=Furious Gladiator's Boots of Triumph",  "=ds=#s12#, #a2#", "", "0.86%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Mail"]};
			{ 2, 41065, "", "=q4=Furious Gladiator's Wristguards of Dominance", "=ds=#s8#, #a3#", "", "0.86%"};
			{ 3, 41070, "", "=q4=Furious Gladiator's Waistguard of Dominance",  "=ds=#s10#, #a3#", "", "0.86%"};
			{ 4, 41075, "", "=q4=Furious Gladiator's Sabatons of Dominance", "=ds=#s12#, #a3#", "", "0.86%"};
			{ 6, 41060, "", "=q4=Furious Gladiator's Wristguards of Salvation", "=ds=#s8#, #a3#", "", "0.86%"};
			{ 7, 41051, "", "=q4=Furious Gladiator's Waistguard of Salvation",  "=ds=#s10#, #a3#", "", "0.86%"};
			{ 8, 41055, "", "=q4=Furious Gladiator's Sabatons of Salvation", "=ds=#s12#, #a3#", "", "0.86%"};
			{ 10, 41225, "", "=q4=Furious Gladiator's Wristguards of Triumph", "=ds=#s8#, #a3#", "", "0.86%"};
			{ 11, 41235, "", "=q4=Furious Gladiator's Waistguard of Triumph",  "=ds=#s10#, #a3#", "", "0.86%"};
			{ 12, 41230, "", "=q4=Furious Gladiator's Sabatons of Triumph", "=ds=#s12#, #a3#", "", "0.86%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Plate"]};
			{ 17, 40983, "", "=q4=Furious Gladiator's Bracers of Salvation", "=ds=#s8#, #a4#", "", "0.86%"};
			{ 18, 40976, "", "=q4=Furious Gladiator's Girdle of Salvation", "=ds=#s10#, #a4#", "", "0.86%"};
			{ 19, 40977, "", "=q4=Furious Gladiator's Greaves of Salvation", "=ds=#s12#, #a4#", "", "0.86%"};
			{ 21, 40889, "", "=q4=Furious Gladiator's Bracers of Triumph", "=ds=#s8#, #a4#", "", "0.86%"};
			{ 22, 40881, "", "=q4=Furious Gladiator's Girdle of Triumph", "=ds=#s10#, #a4#", "", "0.86%"};
			{ 23, 40882, "", "=q4=Furious Gladiator's Greaves of Triumph", "=ds=#s12#, #a4#", "", "0.86%"};
		};
		{
			{ 1, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Back"]};
			{ 2, 42071, "", "=q4=Furious Gladiator's Cloak of Ascendancy", "=ds=#s4#", "", "0.86%"};
			{ 3, 42073, "", "=q4=Furious Gladiator's Cloak of Deliverance", "=ds=#s4#", "", "0.86%"};
			{ 4, 42069, "", "=q4=Furious Gladiator's Cloak of Dominance", "=ds=#s4#", "", "0.86%"};
			{ 5, 42072, "", "=q4=Furious Gladiator's Cloak of Salvation", "=ds=#s4#", "", "0.86%"};
			{ 6, 42070, "", "=q4=Furious Gladiator's Cloak of Subjugation", "=ds=#s4#", "", "0.86%"};
			{ 7, 42074, "", "=q4=Furious Gladiator's Cloak of Triumph", "=ds=#s4#", "", "0.86%"};
			{ 8, 42075, "", "=q4=Furious Gladiator's Cloak of Victory", "=ds=#s4#", "", "0.86%"};
			{ 10, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Ring"]};
			{ 11, 42116, "", "=q4=Furious Gladiator's Band of Dominance", "=ds=#s13#", "", "0.86%"};
			{ 12, 42117, "", "=q4=Furious Gladiator's Band of Triumph", "=ds=#s13#", "", "0.86%"};
			{ 16, 0, "INV_Box_01", "=q6="..AL["PvP Non-Set Epics"], "=q5="..BabbleInventory["Neck"]};
			{ 17, 42037, "", "=q4=Furious Gladiator's Pendant of Ascendancy", "=ds=#s2#", "", "0.86%"};
			{ 18, 42039, "", "=q4=Furious Gladiator's Pendant of Deliverance", "=ds=#s2#", "", "0.86%"};
			{ 19, 42036, "", "=q4=Furious Gladiator's Pendant of Dominance", "=ds=#s2#", "", "0.86%"};
			{ 20, 42040, "", "=q4=Furious Gladiator's Pendant of Salvation", "=ds=#s2#", "", "0.86%"};
			{ 21, 42038, "", "=q4=Furious Gladiator's Pendant of Subjugation", "=ds=#s2#", "", "0.86%"};
			{ 22, 46373, "", "=q4=Furious Gladiator's Pendant of Sundering", "=ds=#s2#", "", "0.86%"};
			{ 23, 42034, "", "=q4=Furious Gladiator's Pendant of Triumph", "=ds=#s2#", "", "0.86%"};
			{ 24, 42035, "", "=q4=Furious Gladiator's Pendant of Victory", "=ds=#s2#", "", "0.86%"};
		};
	};
	info = {
...
AtlasLoot_Data["OnyxiasLairOnyxia"] = {
	["Normal_H"] = {
		{
...
AtlasLoot_Data["PitOfSaronForgemasterGarfrost"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["PitOfSaronKrickAndIck"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["PitOfSaronScourgelordTyrannus"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfReflectionFalric"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfReflectionMarwyn"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["HallsOfReflectionTheLichKing"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["FrozenHallsTrash"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelLordMarrowgar"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelLadyDeathwhisper"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelGunshipBattle"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelDeathbringerSaurfang"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelFestergut"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelRotface"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelProfessorPutricide"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelBloodPrinceCouncil"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelBloodQueenLanathel"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelValithriaDreamwalker"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelSindragosa"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelTheLichKing"] = {
	["Normal"] = {
		{
...
AtlasLoot_Data["IcecrownCitadelTrash"] = {
	["25Man"] = {
		{
	...
	["Normal"] = {
		{
			...
			{ 9, 40830, "", "=q4=Relentless Gladiator's Dreadplate Helm", "=ds=", "#FROST:95#"};
			{ 10, 40871, "", "=q4=Relentless Gladiator's Dreadplate Shoulders", "=ds=", "#FROST:60#"};
			{ 11, 40791, "", "=q4=Relentless Gladiator's Dreadplate Chestpiece", "=ds=", "#FROST:95#"};
			{ 12, 40811, "", "=q4=Relentless Gladiator's Dreadplate Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 40851, "", "=q4=Relentless Gladiator's Dreadplate Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41328, "", "=q4=Relentless Gladiator's Wyrmhide Helm", "=ds=", "#FROST:95#"};
			{ 10, 41282, "", "=q4=Relentless Gladiator's Wyrmhide Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41317, "", "=q4=Relentless Gladiator's Wyrmhide Robes", "=ds=", "#FROST:95#"};
			{ 12, 41294, "", "=q4=Relentless Gladiator's Wyrmhide Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41305, "", "=q4=Relentless Gladiator's Wyrmhide Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41679, "", "=q4=Relentless Gladiator's Dragonhide Helm", "=ds=", "#FROST:95#"};
			{ 10, 41716, "", "=q4=Relentless Gladiator's Dragonhide Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41662, "", "=q4=Relentless Gladiator's Dragonhide Robes", "=ds=", "#FROST:95#"};
			{ 12, 41774, "", "=q4=Relentless Gladiator's Dragonhide Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41668, "", "=q4=Relentless Gladiator's Dragonhide Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41322, "", "=q4=Relentless Gladiator's Kodohide Helm", "=ds=", "#FROST:95#"};
			{ 10, 41276, "", "=q4=Relentless Gladiator's Kodohide Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41311, "", "=q4=Relentless Gladiator's Kodohide Robes", "=ds=", "#FROST:95#"};
			{ 12, 41288, "", "=q4=Relentless Gladiator's Kodohide Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41299, "", "=q4=Relentless Gladiator's Kodohide Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41158, "", "=q4=Relentless Gladiator's Chain Helm", "=ds=", "#FROST:95#"};
			{ 10, 41218, "", "=q4=Relentless Gladiator's Chain Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41088, "", "=q4=Relentless Gladiator's Chain Armor", "=ds=", "#FROST:95#"};
			{ 12, 41144, "", "=q4=Relentless Gladiator's Chain Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 41206, "", "=q4=Relentless Gladiator's Chain Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41947, "", "=q4=Relentless Gladiator's Silk Cowl", "=ds=", "#FROST:95#"};
			{ 10, 41966, "", "=q4=Relentless Gladiator's Silk Amice", "=ds=", "#FROST:60#"};
			{ 11, 41954, "", "=q4=Relentless Gladiator's Silk Raiment", "=ds=", "#FROST:95#"};
			{ 12, 41972, "", "=q4=Relentless Gladiator's Silk Handguards", "=ds=", "#FROST:60#"};
			{ 13, 41960, "", "=q4=Relentless Gladiator's Silk Trousers", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 40831, "", "=q4=Relentless Gladiator's Scaled Helm", "=ds=", "#FROST:95#"};
			{ 10, 40872, "", "=q4=Relentless Gladiator's Scaled Shoulders", "=ds=", "#FROST:60#"};
			{ 11, 40792, "", "=q4=Relentless Gladiator's Scaled Chestpiece", "=ds=", "#FROST:95#"};
			{ 12, 40812, "", "=q4=Relentless Gladiator's Scaled Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 40852, "", "=q4=Relentless Gladiator's Scaled Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 40934, "", "=q4=Relentless Gladiator's Ornamented Headcover", "=ds=", "#FROST:95#"};
			{ 10, 40964, "", "=q4=Relentless Gladiator's Ornamented Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 40910, "", "=q4=Relentless Gladiator's Ornamented Chestguard", "=ds=", "#FROST:95#"};
			{ 12, 40928, "", "=q4=Relentless Gladiator's Ornamented Gloves", "=ds=", "#FROST:60#"};
			{ 13, 40940, "", "=q4=Relentless Gladiator's Ornamented Legplates", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41916, "", "=q4=Relentless Gladiator's Satin Hood", "=ds=", "#FROST:95#"};
			{ 10, 41935, "", "=q4=Relentless Gladiator's Satin Mantle", "=ds=", "#FROST:60#"};
			{ 11, 41922, "", "=q4=Relentless Gladiator's Satin Robe", "=ds=", "#FROST:95#"};
			{ 12, 41941, "", "=q4=Relentless Gladiator's Satin Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41928, "", "=q4=Relentless Gladiator's Satin Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41855, "", "=q4=Relentless Gladiator's Mooncloth Hood", "=ds=", "#FROST:95#"};
			{ 10, 41870, "", "=q4=Relentless Gladiator's Mooncloth Mantle", "=ds=", "#FROST:60#"};
			{ 11, 41860, "", "=q4=Relentless Gladiator's Mooncloth Robe", "=ds=", "#FROST:95#"};
			{ 12, 41875, "", "=q4=Relentless Gladiator's Mooncloth Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41865, "", "=q4=Relentless Gladiator's Mooncloth Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41673, "", "=q4=Relentless Gladiator's Leather Helm", "=ds=", "#FROST:95#"};
			{ 10, 41684, "", "=q4=Relentless Gladiator's Leather Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41651, "", "=q4=Relentless Gladiator's Leather Tunic", "=ds=", "#FROST:95#"};
			{ 12, 41768, "", "=q4=Relentless Gladiator's Leather Gloves", "=ds=", "#FROST:60#"};
			{ 13, 41656, "", "=q4=Relentless Gladiator's Leather Legguards", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41020, "", "=q4=Relentless Gladiator's Mail Helm", "=ds=", "#FROST:95#"};
			{ 10, 41045, "", "=q4=Relentless Gladiator's Mail Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 40995, "", "=q4=Relentless Gladiator's Mail Armor", "=ds=", "#FROST:95#"};
			{ 12, 41008, "", "=q4=Relentless Gladiator's Mail Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 41034, "", "=q4=Relentless Gladiator's Mail Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41152, "", "=q4=Relentless Gladiator's Linked Helm", "=ds=", "#FROST:95#"};
			{ 10, 41212, "", "=q4=Relentless Gladiator's Linked Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 41082, "", "=q4=Relentless Gladiator's Linked Armor", "=ds=", "#FROST:95#"};
			{ 12, 41138, "", "=q4=Relentless Gladiator's Linked Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 41200, "", "=q4=Relentless Gladiator's Linked Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41014, "", "=q4=Relentless Gladiator's Ringmail Helm", "=ds=", "#FROST:95#"};
			{ 10, 41039, "", "=q4=Relentless Gladiator's Ringmail Spaulders", "=ds=", "#FROST:60#"};
			{ 11, 40994, "", "=q4=Relentless Gladiator's Ringmail Armor", "=ds=", "#FROST:95#"};
			{ 12, 41002, "", "=q4=Relentless Gladiator's Ringmail Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 41028, "", "=q4=Relentless Gladiator's Ringmail Leggings", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 41994, "", "=q4=Relentless Gladiator's Felweave Cowl", "=ds=", "#FROST:95#"};
			{ 10, 42012, "", "=q4=Relentless Gladiator's Felweave Amice", "=ds=", "#FROST:60#"};
			{ 11, 41999, "", "=q4=Relentless Gladiator's Felweave Raiment", "=ds=", "#FROST:95#"};
			{ 12, 42018, "", "=q4=Relentless Gladiator's Felweave Handguards", "=ds=", "#FROST:60#"};
			{ 13, 42006, "", "=q4=Relentless Gladiator's Felweave Trousers", "=ds=", "#FROST:95#"};
	...
	["Normal"] = {
		{
			...
			{ 9, 40829, "", "=q4=Relentless Gladiator's Plate Helm", "=ds=", "#FROST:95#"};
			{ 10, 40870, "", "=q4=Relentless Gladiator's Plate Shoulders", "=ds=", "#FROST:60#"};
			{ 11, 40790, "", "=q4=Relentless Gladiator's Plate Chestpiece", "=ds=", "#FROST:95#"};
			{ 12, 40810, "", "=q4=Relentless Gladiator's Plate Gauntlets", "=ds=", "#FROST:60#"};
			{ 13, 40850, "", "=q4=Relentless Gladiator's Plate Legguards", "=ds=", "#FROST:95#"};
